...
class BibliotecaRoutes
{
    ...
    config() : void
    {
        ...
        this.router.get('/mostrarbiblioteca/',validarToken,bibliotecaController.mostrar_biblioteca);
        this.router.get('/usuariobiblioteca/:id',validarToken,bibliotecaController.usuario_biblioteca);
