...
class VentasController {
    ...
    ingresaVenta(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            resp = yield database_1.default.query('UPDATE biblioteca SET precio_juego = (SELECT precio FROM juegos WHERE id_juego = ?) WHERE id_usuario = ? AND id_juego = ?', [parametros.id_juego, parametros.id_usuario, parametros.id_juego]);
            res.json(resp);
            //res.json(null);
        });
    }
    ...
    totalPagado(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resp = yield database_1.default.query(`SELECT id_usuario,SUM(precio_juego) AS Total FROM ventas WHERE id_usuario = ${id_usuario}`);
            res.json(resp);
        });
    }
}
